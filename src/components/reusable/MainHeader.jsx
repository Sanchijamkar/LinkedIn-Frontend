            ...
            <div className="flex justify-around lg:max-w-screen-lg mx-auto">
                <div className="w-full flex gap-3  items-center justify-around px-2">
                    ...
                    <button onClick={ () => goToHome("/home")}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-51.2 -65.2 614.40 614.40" class="w-6 h-6 fill-current text-gray-800">
                    ...
                    <button onClick={() => navigate("/mynetwork")}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -1 52 52" class="w-5 h-5 fill-current text-gray-800 transform scale-x-[-1]"><g>
                    ...
                    <button onClick={() => navigate("/jobs")}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2.4 -2.4 28.80 28.80" class="w-6 h-6 fill-current text-gray-800 stroke-current stroke-0">
                    ...
                    <button onClick={() => navigate("/notification-page")}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1.7 -2.7 20.40 19.40" class="w-6 h-6 fill-current text-gray-800">
